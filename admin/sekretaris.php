<?php
$halaman = 'Laporan - Badan Usaha Sekretaris';
                ...
                <div class="row row-0">
                    <div class="col">
                        <div class="card-body">
                            ...
                            <?php
                            $query = $koneksi->query("SELECT * FROM laporan WHERE id_laporan = '5'");
...
$update = $koneksi->query("UPDATE laporan SET isilaporan = '".$laporanksp."' WHERE id_laporan = '5'  ");
$_SESSION['pesan'] = 'Ubah';
